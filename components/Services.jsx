...
function Services() {
  return (
    <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am an aspiring frontend developer from Munich, Germany. I am passionate about creating visually stunning and user-friendly websites.</p>
